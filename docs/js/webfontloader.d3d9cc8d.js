    ...
    3657: function (t, n, i) {
      ...
      i(1703),
        ...
        (function () {
          ...
          function E(t) {
            t.g && p(t.f, [t.a.c("wf", "loading")]), O(t, "loading");
          }
          function I(t) {
            if (t.g) {
          ...
          function O(t, n, i) {
            t.j && t.h[n] && (i ? t.h[n](i.c, S(i)) : t.h[n]());
          }
          function P() {
            this.c = {};
          }
          ...
          function $(t, n, i, e, o, a, s) {
            (this.v = t),
              ...
              (t = new j(this.a.c + ",serif", S(this.a))),
              (t = L(t)),
              (this.g.a.style.cssText = t),
              (t = new j(this.a.c + ",sans-serif", S(this.a))),
              (t = L(t)),
              (this.h.a.style.cssText = t),
              (t = new j("serif", S(this.a))),
              (t = L(t)),
              (this.j.a.style.cssText = t),
              (t = new j("sans-serif", S(this.a))),
              (t = L(t)),
          ...
          function z(t, n, i) {
            for (var e in q)
              if (q.hasOwnProperty(e) && n === t.f[q[e]] && i === t.f[q[e]])
                return !0;
            return !1;
          }
          function G(t) {
          ...
          function Q(t, n, i, e, o) {
            var a = 0 == --t.h;
            (t.f || t.g) &&
              setTimeout(function () {
                var t = o || null,
                  r = e || {};
                if (0 === i.length && a) I(n.a);
                else {
                  ...
                  for (c = 0; c < i.length; c++) {
                    ...
                    if (
                      (u.g &&
                        p(u.f, [u.a.c("wf", g.c, S(g).toString(), "loading")]),
                      O(u, "fontloading", g),
                      (u = null),
                      null === V)
                    )
                      if (window.FontFace) {
                        ...
                        V = g ? 42 < parseInt(g[1], 10) : !d;
                      } else V = !1;
                    (u = V
                      ? new D(s(n.g, n), s(n.h, n), n.c, h, n.s, l)
                      : new $(s(n.g, n), s(n.h, n), n.c, h, n.s, t, l)),
                      f.push(u);
                  }
          ...
          (U.prototype.g = function (t) {
            ...
            n.g &&
              p(
                n.f,
                [n.a.c("wf", t.c, S(t).toString(), "active")],
                [
                  n.a.c("wf", t.c, S(t).toString(), "loading"),
                  n.a.c("wf", t.c, S(t).toString(), "inactive"),
                ]
              ),
              O(n, "fontactive", t),
              (this.m = !0),
            ...
            (U.prototype.h = function (t) {
              var n = this.a;
              if (n.g) {
                var i = g(n.f, n.a.c("wf", t.c, S(t).toString(), "active")),
                  e = [],
                  o = [n.a.c("wf", t.c, S(t).toString(), "loading")];
                i || e.push(n.a.c("wf", t.c, S(t).toString(), "inactive")),
                  p(n.f, e, o);
              }
              O(n, "fontinactive", t), X(this);
            }),
            (J.prototype.load = function (t) {
              (this.c = new c(this.j, t.context || this.j)),
                (this.g = !1 !== t.events),
                (this.f = !1 !== t.classes),
                Y(this, new N(this.c, t), t);
            }),
                  ...
                  if (o)
                    for (var r = 0; r < o.length; r++) {
                      ...
                      void 0 != o[r].fontStyle && void 0 != o[r].fontWeight
                        ? ((i = o[r].fontStyle + o[r].fontWeight),
                          s.push(new j(c, i)))
                        : s.push(new j(c));
                    }
                  t(s);
            ...
            (tt.prototype.load = function (t) {
              var n,
                ...
                s = new m();
              for (n = 0, i = e.length; n < i; n++) v(this.c, e[n], y(s));
              var r = [];
              for (n = 0, i = o.length; n < i; n++)
                if (((e = o[n].split(":")), e[1]))
                  for (var c = e[1].split(","), f = 0; f < c.length; f += 1)
                    r.push(new j(e[0], c[f]));
                else r.push(new j(e[0]));
              b(s, function () {
                t(r, a);
              });
            });
          var it = "https://fonts.googleapis.com/css";
          function et(t, n) {
          ...
          function ht(t) {
            for (var n = t.f.length, i = 0; i < n; i++) {
              ...
              for (
                t.c[o] || ((e = st[o]) && (t.c[o] = e)), e = 0;
                e < a.length;
                e += 1
              )
                t.a.push(new j(o, a[e]));
            }
          }
          function lt(t, n) {
            (this.c = t), (this.a = n);
          ...
          (lt.prototype.load = function (t) {
            var n = new m(),
              i = this.c,
              e = new nt(this.a.api, this.a.text),
              o = this.a.families;
            et(e, o);
            var a = new at(o);
            ht(a),
...
//# sourceMappingURL=webfontloader.d3d9cc8d.js.map
